                                ...
                                <div class="banner-slider">
                                    <div class="slider slider-for">
                                        <div class="slider-banner-image">
                                            <img src="./assets/images/details-slider/1.jpg" alt="Car-Image">
                                        </div> 
                                        <div class="slider-banner-image">
                                            <img src="./assets/images/details-slider/2.jpg" alt="Car-Image">
                                        </div> 
                                        <div class="slider-banner-image">
                                            <img src="./assets/images/details-slider/3.jpg" alt="Car-Image">
                                        </div> 
                                        <div class="slider-banner-image">
                                            <img src="./assets/images/details-slider/4.jpg" alt="Car-Image">
                                        </div> 
                                        <div class="slider-banner-image">
                                            <img src="./assets/images/details-slider/5.jpg" alt="Car-Image">
                                        </div> 
                                        <div class="slider-banner-image">
                                            <img src="./assets/images/details-slider/6.jpg" alt="Car-Image">
                                        </div> 
                                        <div class="slider-banner-image">
                                            <img src="./assets/images/details-slider/3.jpg" alt="Car-Image">
                                        </div> 
                                    ...
                                    <div class="slider slider-nav thumb-image">
                                        <div class="thumbnail-image">
                                            <div class="thumbImg">
                                                <img src="./assets/images/details-slider/th-1.jpg" alt="slider-img">
                                            </div>
                                        </div>
                                        <div class="thumbnail-image">
                                            <div class="thumbImg">
                                                <img src="./assets/images/details-slider/th-2.jpg" alt="slider-img">
                                            </div>
                                        </div>
                                        <div class="thumbnail-image">
                                            <div class="thumbImg">
                                                <img src="./assets/images/details-slider/th-3.jpg" alt="slider-img">
                                            </div>
                                        </div>
                                        <div class="thumbnail-image">
                                            <div class="thumbImg">
                                                <img src="./assets/images/details-slider/th-4.jpg" alt="slider-img">
                                            </div>
                                        </div>
                                        <div class="thumbnail-image">
                                            <div class="thumbImg">
                                                <img src="./assets/images/details-slider/th-5.jpg" alt="slider-img">
                                            </div>
                                        </div>
                                        <div class="thumbnail-image">
                                            <div class="thumbImg">
                                                <img src="./assets/images/details-slider/th-6.jpg" alt="slider-img">
                                            </div>
                                        </div>
                                        <div class="thumbnail-image">
                                            <div class="thumbImg">
                                ...
                                <div class="ttm-pf-detailbox">
                                    <ul class="ttm-pf-detailbox-list">
                                        <li class="ttm-pf-details-date">
                                            ...
                                            <span class="ttm-pf-right-details">China</span>
                                        </li>
                                        <li class="ttm-pf-details-date">
                                            <i class="ti-user"></i>
