                                ...
                                <div class="card-body">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title_en" class="form-control" placeholder="ادخل الاسم بالانجليزية" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">الاسم (العربية)</label>
                                            <input type="text" name="title_ar" class="form-control" placeholder="ادخل الاسم بالعربية" />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="text_en" class="form-control" rows="3"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">النص (العربية)</label>
                                            <textarea name="text_ar" class="form-control" rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
