    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h5>{{ $material->name_ar . " - " . $material->name_en }}</h5>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <div class="filter-container p-0 row">
                                        ...
                                        @foreach ($material->gallery as $one)                                            
            ...
            <div class="modal fade" id="modal-default">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{ url("admin/materials/$material->id/gallery") }}" method="post" enctype="multipart/form-data">
                            @csrf
